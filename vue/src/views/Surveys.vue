  ...
  <PageComponent>
    ...
    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3">
      <div
        ...
        :key="survey.id"
        class="flex flex-col py-4 px-6 shadow-md bg-white hover:bg-gray-50 hover:scale-[1.02] transition-all duration-200 ease-linear h-[470px] cursor-pointer"
      >
        <img
          :src="survey.image"
          :alt="'Survey' + survey.id"
